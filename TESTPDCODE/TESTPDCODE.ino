...
int initial_motor_speed = 120;        //can change the initial speed that you prefer
int maxSpeed = 255;                 //if the motor is too fast, decrease the max speed and vice versa
float Kp = 0.1;       //will be change using potentiometer
...
void motor_control()
{
    ...
    right_motor_speed = right_motor_speed +22  ; //this line is needed if your motor didn't have same speed
